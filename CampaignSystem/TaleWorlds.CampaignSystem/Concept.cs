...
namespace TaleWorlds.CampaignSystem
{
	...
	public class Concept : MBObjectBase
	{
		...
		public override void Deserialize(MBObjectManager objectManager, XmlNode node)
		{
			...
			this.Title = new TextObject(node.Attributes.get_ItemOf("title").Value, null);
			this.Description = new TextObject(node.Attributes.get_ItemOf("text").Value, null);
			this.FilterGroup = ((node.Attributes.get_ItemOf("group") != null) ? node.Attributes.get_ItemOf("group").Value : "");
			this.LinkID = node.Attributes.get_ItemOf("link_id").Value;
		}
