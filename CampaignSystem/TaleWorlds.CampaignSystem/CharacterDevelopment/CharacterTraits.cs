...
namespace TaleWorlds.CampaignSystem.CharacterDevelopment
{
	...
	{
		// Token: 0x06002F31 RID: 12081 RVA: 0x000C297C File Offset: 0x000C0B7C
		...
		// Token: 0x06002F32 RID: 12082 RVA: 0x000C298A File Offset: 0x000C0B8A
		protected override void AutoGeneratedInstanceCollectObjects(List<object> collectedObjects)
		{
			base.AutoGeneratedInstanceCollectObjects(collectedObjects);
		}

		// Token: 0x06002F33 RID: 12083 RVA: 0x000C2993 File Offset: 0x000C0B93
		public CharacterTraits(CharacterTraits propertyOwner) : base(propertyOwner)
		{
		}

		// Token: 0x06002F34 RID: 12084 RVA: 0x000C299C File Offset: 0x000C0B9C
		public CharacterTraits()
		{
		}

		// Token: 0x17000B49 RID: 2889
		// (get) Token: 0x06002F35 RID: 12085 RVA: 0x000C29A4 File Offset: 0x000C0BA4
		public int Mercy
		{
			get
			{
		...
		// (get) Token: 0x06002F36 RID: 12086 RVA: 0x000C29B1 File Offset: 0x000C0BB1
		public int Valor
		{
			get
			{
		...
		// (get) Token: 0x06002F37 RID: 12087 RVA: 0x000C29BE File Offset: 0x000C0BBE
		public int Honor
		{
			get
			{
		...
		// (get) Token: 0x06002F38 RID: 12088 RVA: 0x000C29CB File Offset: 0x000C0BCB
		...
		// (get) Token: 0x06002F39 RID: 12089 RVA: 0x000C29D8 File Offset: 0x000C0BD8
		...
		// Token: 0x06002F3A RID: 12090 RVA: 0x000C29E8 File Offset: 0x000C0BE8
		public override void Deserialize(MBObjectManager objectManager, XmlNode node)
		{
			...
			foreach (object obj in node.ChildNodes)
			{
				...
				if (xmlNode.NodeType != 8)
				{
					...
					string value = attributes.get_ItemOf("id").Value;
					string value2 = attributes.get_ItemOf("value").Value;
			...
			foreach (object obj2 in node.ChildNodes)
			{
				...
				if (xmlNode2.NodeType != 8)
				{
					...
					if (text == "Trait")
					{
						...
						{
							XmlAttribute xmlAttribute = xmlNode2.Attributes.get_ItemOf("id");
					...
					if (text != null)
					{
						...
						if (object2 != null)
						{
							XmlAttribute xmlAttribute2 = xmlNode2.Attributes.get_ItemOf("value");
		...
		// Token: 0x06002F3B RID: 12091 RVA: 0x000C2B94 File Offset: 0x000C0D94
		protected override void AfterLoad()
		{
			if (MBSaveLoad.LastLoadedGameVersion < ApplicationVersion.FromString("e1.8.1.0", 66233))
			{
