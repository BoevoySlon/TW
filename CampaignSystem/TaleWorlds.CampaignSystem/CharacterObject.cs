...
namespace TaleWorlds.CampaignSystem
{
	...
	public sealed class CharacterObject : BasicCharacterObject, ICharacterData
	{
		...
		public override void Deserialize(MBObjectManager objectManager, XmlNode node)
		{
			...
			XmlNode xmlNode3 = node.Attributes.get_ItemOf("is_child_template");
			this.IsChildTemplate = (xmlNode3 != null && Convert.ToBoolean(xmlNode3.InnerText));
			XmlNode xmlNode4 = node.Attributes.get_ItemOf("is_hidden_encyclopedia");
			...
			XmlNode xmlNode7 = node.Attributes.get_ItemOf("voice");
			if (xmlNode7 != null)
			{
				this._persona = MBObjectManager.Instance.GetObject<TraitObject>(xmlNode7.Value);
			}
			XmlNode xmlNode8 = node.Attributes.get_ItemOf("is_basic_troop");
			if (xmlNode8 != null)
			{
			...
			XmlNode xmlNode9 = node.Attributes.get_ItemOf("level");
