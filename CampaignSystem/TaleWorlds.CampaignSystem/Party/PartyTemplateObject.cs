			...
			foreach (object obj in node.ChildNodes)
			{
				...
				if (xmlNode.Name == "stacks")
				{
					foreach (object obj2 in xmlNode.ChildNodes)
					{
						...
						{
							PartyTemplateStack item = new PartyTemplateStack((CharacterObject)objectManager.ReadObjectReferenceFromXml("troop", typeof(CharacterObject), xmlNode2), Convert.ToInt32(xmlNode2.Attributes.get_ItemOf("min_value").Value), Convert.ToInt32(xmlNode2.Attributes.get_ItemOf("max_value").Value));
