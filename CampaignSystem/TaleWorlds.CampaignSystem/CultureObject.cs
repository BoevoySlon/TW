...
namespace TaleWorlds.CampaignSystem
{
	...
	public sealed class CultureObject : BasicCultureObject
	{
		...
		public override void Deserialize(MBObjectManager objectManager, XmlNode node)
		{
			...
			this.TownEdgeNumber = ((node.Attributes.get_ItemOf("town_edge_number") == null) ? 0 : Convert.ToInt32(node.Attributes.get_ItemOf("town_edge_number").Value));
			this.MilitiaBonus = ((node.Attributes.get_ItemOf("militia_bonus") == null) ? 0 : Convert.ToInt32(node.Attributes.get_ItemOf("militia_bonus").Value));
			this.ProsperityBonus = ((node.Attributes.get_ItemOf("prosperity_bonus") == null) ? 0 : Convert.ToInt32(node.Attributes.get_ItemOf("prosperity_bonus").Value));
			...
			if (node.Attributes.get_ItemOf("board_game_type") != null && Enum.TryParse<CultureObject.BoardGameType>(node.Attributes.get_ItemOf("board_game_type").Value, out boardGame))
			{
				...
				if (xmlNode.Name == "default_policies")
				{
					using (IEnumerator enumerator2 = xmlNode.ChildNodes.GetEnumerator())
					{
						while (enumerator2.MoveNext())
						{
							...
							PolicyObject @object = objectManager.GetObject<PolicyObject>(xmlNode2.Attributes.get_ItemOf("id").Value);
				...
				if (xmlNode.Name == "male_names")
				{
					using (IEnumerator enumerator2 = xmlNode.ChildNodes.GetEnumerator())
					{
						while (enumerator2.MoveNext())
						{
							...
							this._maleNameList.Add(new TextObject(xmlNode3.Attributes.get_ItemOf("name").Value, null));
						}
						continue;
					}
				}
				if (xmlNode.Name == "female_names")
				{
					using (IEnumerator enumerator2 = xmlNode.ChildNodes.GetEnumerator())
					{
						while (enumerator2.MoveNext())
						{
							...
							this._femaleNameList.Add(new TextObject(xmlNode4.Attributes.get_ItemOf("name").Value, null));
						}
						continue;
					}
				}
				if (xmlNode.Name == "clan_names")
				{
					using (IEnumerator enumerator2 = xmlNode.ChildNodes.GetEnumerator())
					{
						while (enumerator2.MoveNext())
						{
							...
							this._clanNameList.Add(new TextObject(xmlNode5.Attributes.get_ItemOf("name").Value, null));
						}
						continue;
					}
				}
				if (xmlNode.Name == "cultural_feats")
				{
					using (IEnumerator enumerator2 = xmlNode.ChildNodes.GetEnumerator())
					{
						while (enumerator2.MoveNext())
						{
							...
							string value = ((XmlNode)obj6).Attributes.get_ItemOf("id").Value;
				...
				if (xmlNode.Name == "possible_clan_banner_icon_ids")
				{
					using (IEnumerator enumerator2 = xmlNode.ChildNodes.GetEnumerator())
					{
						while (enumerator2.MoveNext())
						{
							...
							int item;
							int.TryParse(((XmlNode)obj7).Attributes.get_ItemOf("id").Value, out item);
							mblist.Add(item);
						}
						continue;
					}
