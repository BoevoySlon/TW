...
namespace TaleWorlds.Core
{
	...
	public class WeaponComponentData
	{
		...
		public void Deserialize(ItemObject item, XmlNode node)
		{
			...
			XmlAttribute xmlAttribute = node.Attributes.get_ItemOf("physics_material");
			this.PhysicsMaterial = ((xmlAttribute != null) ? xmlAttribute.Value : null);
			XmlAttribute xmlAttribute2 = node.Attributes.get_ItemOf("flying_sound_code");
			this.FlyingSoundCode = ((xmlAttribute2 != null) ? xmlAttribute2.Value : null);
			XmlAttribute xmlAttribute3 = node.Attributes.get_ItemOf("passby_sound_code");
			this.PassbySoundCode = ((xmlAttribute3 != null) ? xmlAttribute3.Value : null);
			XmlAttribute xmlAttribute4 = node.Attributes.get_ItemOf("item_usage");
			this.ItemUsage = ((xmlAttribute4 != null) ? xmlAttribute4.Value : null);
			this.WeaponBalance = ((node.Attributes.get_ItemOf("weapon_balance") != null) ? ((float)int.Parse(node.Attributes.get_ItemOf("weapon_balance").Value) * 0.01f) : 0f);
			this.SwingSpeed = ((node.Attributes.get_ItemOf("speed_rating") != null) ? int.Parse(node.Attributes.get_ItemOf("speed_rating").Value) : 0);
			this.ThrustSpeed = ((node.Attributes.get_ItemOf("thrust_speed") != null) ? int.Parse(node.Attributes.get_ItemOf("thrust_speed").Value) : 0);
			this.MissileSpeed = ((node.Attributes.get_ItemOf("missile_speed") != null) ? int.Parse(node.Attributes.get_ItemOf("missile_speed").Value) : 0);
			this.WeaponLength = ((node.Attributes.get_ItemOf("weapon_length") != null) ? int.Parse(node.Attributes.get_ItemOf("weapon_length").Value) : 0);
			this.ThrustDamage = ((node.Attributes.get_ItemOf("thrust_damage") != null) ? int.Parse(node.Attributes.get_ItemOf("thrust_damage").Value) : 0);
			this.SwingDamage = ((node.Attributes.get_ItemOf("swing_damage") != null) ? int.Parse(node.Attributes.get_ItemOf("swing_damage").Value) : 0);
			this.Accuracy = ((node.Attributes.get_ItemOf("accuracy") != null) ? int.Parse(node.Attributes.get_ItemOf("accuracy").Value) : 100);
			this.ThrustDamageType = ((node.Attributes.get_ItemOf("thrust_damage_type") != null) ? ((DamageTypes)Enum.Parse(typeof(DamageTypes), node.Attributes.get_ItemOf("thrust_damage_type").Value)) : DamageTypes.Blunt);
			this.SwingDamageType = ((node.Attributes.get_ItemOf("swing_damage_type") != null) ? ((DamageTypes)Enum.Parse(typeof(DamageTypes), node.Attributes.get_ItemOf("swing_damage_type").Value)) : DamageTypes.Blunt);
			...
			this.AmmoClass = ((node.Attributes.get_ItemOf("ammo_class") != null) ? ((WeaponClass)Enum.Parse(typeof(WeaponClass), node.Attributes.get_ItemOf("ammo_class").Value)) : WeaponClass.Undefined);
			this.ReloadPhaseCount = ((node.Attributes.get_ItemOf("reload_phase_count") != null) ? short.Parse(node.Attributes.get_ItemOf("reload_phase_count").Value) : 1);
			this.CenterOfMass = (float)this.WeaponLength * 0.5f * 0.01f;
			this.CenterOfMass3D = ((node.Attributes.get_ItemOf("center_of_mass") != null) ? Vec3.Parse(node.Attributes.get_ItemOf("center_of_mass").Value) : Vec3.Zero);
			...
			XmlAttribute xmlAttribute5 = node.Attributes.get_ItemOf("ammo_limit");
			XmlAttribute xmlAttribute6 = node.Attributes.get_ItemOf("stack_amount");
			XmlAttribute xmlAttribute7 = node.Attributes.get_ItemOf("hit_points");
			...
			XmlNode xmlNode = node.Attributes.get_ItemOf("sticking_position");
			if (xmlNode != null)
			{
			...
			XmlNode xmlNode2 = node.Attributes.get_ItemOf("sticking_rotation");
			if (xmlNode2 != null)
			{
			...
			XmlNode xmlNode3 = node.Attributes.get_ItemOf("position");
			if (xmlNode3 != null)
			{
			...
			XmlNode xmlNode4 = node.Attributes.get_ItemOf("rotation");
			if (xmlNode4 != null)
			{
			...
			this.RotationSpeed = ((node.Attributes.get_ItemOf("rotation_speed") != null) ? Vec3.Parse(node.Attributes.get_ItemOf("rotation_speed").Value) : Vec3.Zero);
			XmlAttribute xmlAttribute8 = node.Attributes.get_ItemOf("trail_particle_name");
			...
			foreach (object obj in node.ChildNodes)
			{
				...
				if (xmlNode5.Name == "WeaponFlags")
				{
					foreach (object obj2 in Enum.GetValues(typeof(WeaponFlags)))
					{
						...
						if (xmlNode5.Attributes.get_ItemOf(weaponFlags.ToString()) != null)
						{
							this.WeaponFlags |= weaponFlags;
						}
					}
