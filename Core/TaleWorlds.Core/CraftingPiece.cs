...
namespace TaleWorlds.Core
{
	...
	public sealed class CraftingPiece : MBObjectBase
	{
		...
		public override void Deserialize(MBObjectManager objectManager, XmlNode node)
		{
			...
			this.PieceType = (CraftingPiece.PieceTypes)Enum.Parse(typeof(CraftingPiece.PieceTypes), node.Attributes.get_ItemOf("piece_type").InnerText, true);
			this.MeshName = node.Attributes.get_ItemOf("mesh").InnerText;
			this.Culture = ((node.Attributes.get_ItemOf("mesh") != null) ? ((BasicCultureObject)objectManager.ReadObjectReferenceFromXml("culture", typeof(BasicCultureObject), node)) : null);
			this.Appearance = ((node.Attributes.get_ItemOf("appearance") != null) ? float.Parse(node.Attributes.get_ItemOf("appearance").Value) : 0.5f);
			this.CraftingCost = ((node.Attributes.get_ItemOf("CraftingCost") != null) ? int.Parse(node.Attributes.get_ItemOf("CraftingCost").Value) : 0);
			XmlAttribute xmlAttribute = node.Attributes.get_ItemOf("weight");
			this.Weight = ((xmlAttribute != null) ? float.Parse(xmlAttribute.Value) : 0f);
			XmlAttribute xmlAttribute2 = node.Attributes.get_ItemOf("length");
			...
			{
				XmlAttribute xmlAttribute3 = node.Attributes.get_ItemOf("distance_to_next_piece");
				XmlAttribute xmlAttribute4 = node.Attributes.get_ItemOf("distance_to_previous_piece");
			...
			XmlAttribute xmlAttribute5 = node.Attributes.get_ItemOf("center_of_mass");
			float num = (xmlAttribute5 != null) ? float.Parse(xmlAttribute5.Value) : 0.5f;
			this.CenterOfMass = this.Length * num;
			XmlAttribute xmlAttribute6 = node.Attributes.get_ItemOf("item_holster_pos_shift");
			...
			XmlAttribute xmlAttribute7 = node.Attributes.get_ItemOf("tier");
			...
			XmlAttribute xmlAttribute8 = node.Attributes.get_ItemOf("full_scale");
			...
			XmlAttribute xmlAttribute9 = node.Attributes.get_ItemOf("excluded_item_usage_features");
			this.ItemUsageFeaturesToExclude = ((xmlAttribute9 != null) ? xmlAttribute9.InnerText : "");
			XmlAttribute xmlAttribute10 = node.Attributes.get_ItemOf("required_skill_value");
				...
				if (xmlNode.Attributes != null)
				{
					...
					if (!(name == "StatContributions"))
					{
						if (!(name == "BladeData"))
						{
							if (!(name == "BuildData"))
							{
								if (!(name == "Materials"))
								{
									if (name == "Flags")
									{
										...
										foreach (object obj2 in xmlNode.ChildNodes)
										{
											...
											XmlAttribute xmlAttribute11 = xmlNode2.Attributes.get_ItemOf("name");
											XmlAttribute xmlAttribute12 = xmlNode2.Attributes.get_ItemOf("type");
								...
								else
								{
									...
									foreach (object obj3 in xmlNode.ChildNodes)
									{
										...
										string value2 = xmlNode3.Attributes.get_ItemOf("count").Value;
							...
							{
								XmlAttribute xmlAttribute13 = xmlNode.Attributes.get_ItemOf("piece_offset");
								XmlAttribute xmlAttribute14 = xmlNode.Attributes.get_ItemOf("previous_piece_offset");
								XmlAttribute xmlAttribute15 = xmlNode.Attributes.get_ItemOf("next_piece_offset");
					...
					{
						XmlAttribute xmlAttribute16 = xmlNode.Attributes.get_ItemOf("armor_bonus");
						this.ArmorBonus = ((xmlAttribute16 != null) ? int.Parse(xmlAttribute16.Value) : 0);
						XmlAttribute xmlAttribute17 = xmlNode.Attributes.get_ItemOf("handling_bonus");
						this.HandlingBonus = ((xmlAttribute17 != null) ? int.Parse(xmlAttribute17.Value) : 0);
						XmlAttribute xmlAttribute18 = xmlNode.Attributes.get_ItemOf("swing_damage_bonus");
						this.SwingDamageBonus = ((xmlAttribute18 != null) ? int.Parse(xmlAttribute18.Value) : 0);
						XmlAttribute xmlAttribute19 = xmlNode.Attributes.get_ItemOf("swing_speed_bonus");
						this.SwingSpeedBonus = ((xmlAttribute19 != null) ? int.Parse(xmlAttribute19.Value) : 0);
						XmlAttribute xmlAttribute20 = xmlNode.Attributes.get_ItemOf("thrust_damage_bonus");
						this.ThrustDamageBonus = ((xmlAttribute20 != null) ? int.Parse(xmlAttribute20.Value) : 0);
						XmlAttribute xmlAttribute21 = xmlNode.Attributes.get_ItemOf("thrust_speed_bonus");
						this.ThrustSpeedBonus = ((xmlAttribute21 != null) ? int.Parse(xmlAttribute21.Value) : 0);
						XmlAttribute xmlAttribute22 = xmlNode.Attributes.get_ItemOf("accuracy_bonus");
